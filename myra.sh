...
printf "${reset}"
while read domain ; do puredns bruteforce $HOME/SecLists-master/Discovery/DNS/subdomains-top1million-110000.txt $domain --resolvers $HOME/resolvers.txt | tee -a ${out_folder}/subs.txt ; done < "$domains"
